...
public class MapperDiagnosticTest {
    ...
    public void diagnosticMapAndPrintXml() throws Exception {
        ...
        if ((mapped == null) || (mapped.getGrpHdr() == null
                && (mapped.getCdtTrfTxInf() == null || mapped.getCdtTrfTxInf().isEmpty()))) {
            System.out.println(
                    "MapperDiagnosticTest: top-level map produced empty result, attempting wrapper-aware fallback mapping");
                ...
                if (wrapper != null) {
                    try {
                        ...
                        if (gh != null && gh instanceof com.prowidesoftware.swift.model.mx.dic.GroupHeader2) {
                            mapped.setGrpHdr(Pacs008ToPacs009Mapper.INSTANCE
                                    .map((com.prowidesoftware.swift.model.mx.dic.GroupHeader2) gh));
                        }
                    ...
                    try {
                        ...
                        if (txs instanceof java.util.List) {
                            ...
                            java.util.List<Object> list = (java.util.List<Object>) txs;
                            for (Object o : list) {
                                if (o == null)
                                    continue;
                                try {
                                    ...
                                    com.prowidesoftware.swift.model.mx.dic.CreditTransferTransactionInformation3 txOut = Pacs008ToPacs009Mapper.INSTANCE
                                            .map(txSrc);
                                    if (txOut != null)
                                        mapped.getCdtTrfTxInf().add(txOut);
                                } catch (Exception ex) {
                                    /* ignore per-fallback robustness */ }
                            }
                        }
                    } catch (NoSuchMethodException ns) {
                    }
        ...
        JAXBElement<Pacs00900101> root = new JAXBElement<>(
                new javax.xml.namespace.QName("urn:iso:std:iso:20022:tech:xsd:pacs.009.001.01", "Document"),
                Pacs00900101.class, mapped);
