...
/**
 * Test to demonstrate Pain.001 to PACS.008 transformation with detailed output
 */
public class Pain001ToPacs008DemoTest {

    private final Pain001ToPacs008Mapper mapper = Pain001ToPacs008Mapper.INSTANCE;

    @Test
    @DisplayName("Demonstrate Pain.001 to PACS.008 transformation with detailed output")
    void demonstratePain001ToPacs008Transformation() throws Exception {
        // Create sample Pain.001 document
        CustomerCreditTransferInitiationV12 pain001 = createSamplePain001();

        // Transform to PACS.008
        FIToFICustomerCreditTransferV13 pacs008 = mapper.mapCreditTransferInitiation(pain001);
        ...
        // Print PACS.008 XML
        System.out.println("\n" + "=".repeat(80));
        System.out.println("PACS.008 XML OUTPUT:");
        System.out.println("=".repeat(80));
        try {
            String pacs008Xml = marshalPacs008ToXml(pacs008);
            System.out.println(pacs008Xml);
        } catch (Exception e) {
            System.out.println("Error marshalling PACS.008 to XML: " + e.getMessage());
            e.printStackTrace();
        }
    }

    private String marshalPacs008ToXml(FIToFICustomerCreditTransferV13 pacs008) throws Exception {
        JAXBContext jaxbContext = JAXBContext.newInstance(
            "org.translator.xsd.generated.pacs_008"
        );
        ...
        // Create a JAXBElement wrapper since the class might not have @XmlRootElement
        QName qname = new QName("urn:iso:std:iso:20022:tech:xsd:pacs.008.001.13", "FIToFICstmrCdtTrf");
        JAXBElement<FIToFICustomerCreditTransferV13> jaxbElement =
            new JAXBElement<>(qname, FIToFICustomerCreditTransferV13.class, pacs008);

        marshaller.marshal(jaxbElement, writer);
        return writer.toString();
    }

    private CustomerCreditTransferInitiationV12 createSamplePain001() throws Exception {
    ...
    private void printPain001Summary(CustomerCreditTransferInitiationV12 pain001) {
    ...
    private void printPacs008Summary(FIToFICustomerCreditTransferV13 pacs008) {
